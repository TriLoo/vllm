...
def _get_pinpoint_with_largest_features(
    ...
    largest_feature_pinpoint = (336, 336)
    largest_feature_size = 577
...
def input_processor_for_llava_next(ctx: InputContext,
    ...
    # print('--- image_feature_size in input_processor: ', image_feature_size)
...
class LlavaNextForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    def _image_pixels_to_features(
        ...
        # print('---- shape of input visioni tower image: ', pixel_values.shape)
        image_features = vision_tower(pixel_values)
        # print('---- shape of image_features in pixels to features: ', image_features.shape)
    ...
    def _merge_image_patch_embeddings(self, image_size: torch.Tensor,
        ...
        # print('---- shape of patch_embeddings: ', patch_embeddings.shape)
    ...
    def _process_image_input(
        ...
        # print('---- processing image_pixels patch embedding shape: ', patch_embeddings.shape)
    ...
    def forward(
        ...
        **kwargs: object,
        ...
        if intermediate_tensors is not None:
            ...
            # print('image input is not None: ', image_input is not None)
            # print('keys of image_input: ', image_input.keys())
            # print('--- pixel value in vllm forward: ', image_input['data'].shape)
    ...
    def pooler(
        ...
        print('current pooling metadata: ', pooling_metadata)
...
@MULTIMODAL_REGISTRY.register_max_image_tokens(get_max_llava_next_image_tokens)
@INPUT_REGISTRY.register_input_processor(input_processor_for_llava_next)
class LlavaNextForEmbedding(nn.Module, SupportsMultiModal,
                                        SupportsPP):
